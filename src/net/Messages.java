...
public class Messages {
	...
	public static final int GUILD_MEMBER_ONLINE_STATE_HANDLER = 0x4306; // not
	...
	public static final int USE_SCROLL_REQUEST = 0x4339;
	...
	public static final int UNKNOWN_LOBBY_RESPONSE_84 = 0x4477; // something with the monsters in a quest. make them disappear if field 0x14 is 0. it seems like there are more monsters than usual.
	public static final int UNKNOWN_LOBBY_RESPONSE_85 = 0x4479; // this one seems to be only in infinity survival mode. it changes the map of the game
