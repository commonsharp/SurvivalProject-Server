...
public class ServersInfoHandler extends LoginHandler {
	...
	private class Server {
		...
		private Server(String hostname, int port, String name, short channelType, short serverID, int population, int maxPopulation, String bestGuild) {
