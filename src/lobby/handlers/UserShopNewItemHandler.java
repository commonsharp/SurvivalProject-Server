...
public class UserShopNewItemHandler extends LobbyHandler {
	...
	public void interpretBytes() {
		requestType = input.getInt(0x4C); // 4 - open shop
		...
		System.out.println(input.getInt(0x4C)); // number of items? NO.
		...
		System.out.println(input.getInt(0xA0));
		System.out.println(input.getInt(0xA4)); // NOT USED IN THE FORMAT. DELETE AFTERWARDS
...
//		}
	...
	public byte[] getResponse() {
		...
		output.putInt(0x4, Messages.USER_SHOP_NEW_ITEM_REQUEST);
