...
public class CrystalsInfoHandler extends LobbyHandler {
	...
	public void interpretBytes() {
		...
		for (int i = 0; i < 4; i++) {
			...
			System.out.println(i + " X: " + input.getInt(0x28 + 4 * i));
			System.out.println(i + " Y: " + input.getInt(0x38 + 4 * i));
			System.out.println(i + " Team (30 if not used): " + input.getInt(0x48 + 4 * i));
